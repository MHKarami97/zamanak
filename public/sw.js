try {
  ...
  self.__zamaanak_PRECACHE = [];
}

const CACHE_NAME = "zamaanak-shell-v7";
const STATIC_CACHE = "zamaanak-static-v7";
const APP_ROUTES = ["", "today/", "month/", "leave/", "reports/", "clients/", "projects/", "invoices/", "settings/"];
const STATIC_ASSETS = [
  "manifest.webmanifest",
  "favicon.svg",
  "brand/zamaanak-mark.svg",
  "brand/zamaanak-mark-accent.svg",
  "icons/icon-192.png",
  "icons/icon-512.png",
  "icons/maskable-512.png",
  "og/zamaanak-social-card.png",
  "pwa-precache-manifest.js",
];
const BUILD_ASSETS = Array.isArray(self.__zamaanak_PRECACHE) ? self.__zamaanak_PRECACHE : [];
...
async function networkFirst(request) {
  ...
  try {
    ...
    return (await cache.match(request))
      ...
      || new Response("زمانک در حالت آفلاین آماده نیست. پس از اتصال دوباره تلاش کنید.", {
        status: 503,
