...
- Production Browser Smoke در Revision 4 سبز شد، اما Freelancer Smoke هنوز قبل از Seed کردن Fixture منتظر متن قدیمی مرحله ۲ (`زمانک را برای خودت تنظیم کن`) می‌ماند و روی Welcome/Name مرحله ۱ Timeout می‌کرد. Employee Smoke همان قرارداد قدیمی را داشت و در ادامه Gate به همان Fail می‌رسید.
