...
GitHub باید به‌صورت پیش‌فرض معرفی انگلیسی پروژه را نشان دهد، بدون حذف مستندات فارسی یا شکستن لینک‌های قدیمی. هم‌زمان مسیر دو زبانه‌کردن خود رابط زمانک باید به‌صورت صریح در Roadmap ثبت شود، اما در این فاز هیچ تغییر Runtime یا Schema انجام نمی‌شود.
