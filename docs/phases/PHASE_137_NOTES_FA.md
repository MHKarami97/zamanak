...
Persistence زمانک عمداً با یک debounce کوتاه انجام می‌شود؛ بنابراین Hard Reload چند میلی‌ثانیه بعد از Mutation، رفتار معادل کلیک واقعی کاربر روی Sidebar نیست.
