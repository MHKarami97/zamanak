...
این جدول میان «پشتیبانی APIهای وب»، «انتظار پروژه» و «مرورگر واقعاً اجراشده در Release Gate» تفاوت می‌گذارد. وجود یک API در مرورگر به‌تنهایی به معنی تست کامل تمام جریان‌های زمانک روی آن مرورگر نیست.
...
- **IndexedDB:** محل اصلی ذخیره داده زمانک است و در مرورگرهای مدرن به‌طور گسترده در دسترس است.
...
- **Notification API:** زمانک اعلان محلی همان صفحه را با اجازه کاربر می‌سازد. این پروژه در حال حاضر Push Server و ارسال اعلان از Backend ندارد.
...
- اعلان زمانک فعلاً Local Notification است و برای تحویل Push در زمان بسته‌بودن کامل برنامه طراحی نشده است.
