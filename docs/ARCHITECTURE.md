# zamaanak architecture

zamaanak is a local-first application. Product data is owned by the browser and the domain layer must remain usable without a backend.
