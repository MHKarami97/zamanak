# zamaanak 2.1.0 Release Notes

Prepared on **August 7, 2026**.

zamaanak 2.1.0 is a stability and public-release readiness update. It focuses on local data safety, explicit settings editing, production browser validation, repository contracts, and release documentation.
...
```bash
git tag -a v2.1.0 -m "zamaanak 2.1.0"
