# zamaanak 2.3.2 Release Notes

Release date: 2026-08-09

zamaanak 2.3.2 is a patch release focused on employee-session recovery, work-schedule clarity, theme contrast, CI reliability, and repository documentation. AppData remains on schema v17 with no new migration or dependency.
...
```bash
git tag -a v2.3.2 -m "zamaanak 2.3.2"
