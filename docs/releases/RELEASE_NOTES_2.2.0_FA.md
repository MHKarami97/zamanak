...
زمانک همچنان Local-first است. انتقال بین دستگاه‌ها Backend دائمی یا دیتابیس مرکزی اضافه نمی‌کند. Pairing Code یک Bearer Secret کوتاه‌عمر است و باید خصوصی بماند؛ خود AppData پس از اتصال با AES-GCM منتقل می‌شود.
