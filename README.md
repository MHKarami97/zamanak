...
زمانک یک وب‌اپ متن‌باز، فارسی، راست‌به‌چپ و **Local-first** برای مدیریت زمان و کار روزانه است. کارمند، فریلنسر یا کاربر ترکیبی می‌تواند بدون ساخت حساب کاربری و بدون وابستگی به سرور، ساعت ورود و خروج، ناهار، وقفه، مرخصی، پروژه، صورتحساب و گزارش مالی خود را ثبت کند.
...
> zamaanak is an open-source, Persian-first, RTL, local-first worklog and time-tracking web app for employees, freelancers, and hybrid workers.
...
تصاویر زیر از Build واقعی زمانک و Fixture نمایشی مستقل ساخته شده‌اند؛ Capture رسانه به داده واقعی کاربر دسترسی ندارد.

<p align="center">
  <img src="./docs/assets/screenshots/today-light-desktop.png" alt="صفحه امروز زمانک در تم روشن" width="920" />
</p>

<table>
  <tr>
    <td width="50%"><img src="./docs/assets/screenshots/today-dark-desktop.png" alt="صفحه امروز زمانک در تم تاریک" /></td>
    <td width="50%"><img src="./docs/assets/screenshots/reports-light.png" alt="گزارش‌های زمانک در تم روشن" /></td>
  </tr>
  <tr>
    <td width="50%"><img src="./docs/assets/screenshots/reports-dark.png" alt="گزارش‌های زمانک در تم تاریک" /></td>
    <td width="50%"><img src="./docs/assets/screenshots/today-mobile.png" alt="صفحه امروز زمانک در موبایل" /></td>
  </tr>
</table>
...
<p align="center">
  <img src="./docs/assets/media/onboarding.gif" alt="دموی Onboarding زمانک" width="760" />
</p>
...
زمانک به‌صورت پیش‌فرض اطلاعات کاری شما را به سرور ارسال نمی‌کند. داده‌ها در همان مرورگر و همان دامنه ذخیره می‌شوند.
...
```bash
git clone https://github.com/mhkarami97/zamaanak.git
cd zamaanak
npm ci
npm run dev
```
...
> محاسبات زمانک یک ابزار شخصی و تخمینی است و جایگزین قرارداد استخدام، فیش رسمی حقوق، نظر حسابدار یا قوانین محل کار نیست.
...
hooks/
  ...
  use-zamaanak-controller.ts    Facade اصلی State محصول
