...
const maskStyle: CSSProperties = {
  ...
  WebkitMaskImage: "url('/brand/zamaanak-mark.svg')",
  maskImage: "url('/brand/zamaanak-mark.svg')",
    ...
    >
      ...
      <span
        className={cn(
          ...
          animated && "motion-safe:animate-[zamaanak-breathe_3.2s_ease-in-out_infinite]",
        )}
        style={maskStyle}
      />
    </span>
