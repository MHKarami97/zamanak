  ...
  return (
    <StepShell>
      <div className="mx-auto mb-7 max-w-[720px] text-center" data-onboarding-import>
        ...
        <p>این مرحله کاملاً اختیاری است. Backup زمانک یا CSV را Preview کن؛ تا قبل از تأیید هیچ داده‌ای تغییر نمی‌کند.</p>
      </div>
      <div className="mx-auto grid max-w-[980px] gap-4 text-right" data-onboarding-inline-form>
        ...
        <p className="text-center text-[10px] leading-5 text-[var(--text-muted)]">اگر چیزی برای Import نداری، مستقیم «شروع زمانک» را بزن. این Wizard همیشه از Settings هم در دسترس است.</p>
      </div>
    </StepShell>
  );
}
