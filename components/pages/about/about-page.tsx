...
const externalLinks = [
  { label: "Website", href: "https://mhkarami97.ir", icon: Send },
] as const;
...
const guides = [
  ...
  { title: "حریم خصوصی", description: "داده اصلی روی همین دستگاه می‌ماند؛ زمانک برای نگه‌داری اطلاعات شخصی به حساب ابری نیاز ندارد.", icon: ShieldCheck },
] as const;
    ...
    <div className="grid gap-5">
      ...
      <section className="dashboard-card grid gap-4 rounded-[var(--card-radius)] border border-[var(--dashboard-border)] p-5 sm:p-6">
        <div className="grid max-w-4xl gap-2">
          <strong className="text-lg text-[var(--text)]">زمانک چیست؟</strong>
          <p className="text-[11px] leading-7 text-[var(--text-muted)]">
            زمانک یک ابزار فارسی و Local-first برای ثبت ساعت کاری، حضور و مرخصی، پروژه و مشتری، فاکتور، گزارش و محاسبه حقوق است. طراحی برنامه طوری است که کارهای روزمره بدون ساخت حساب کاربری و حتی در حالت آفلاین ادامه پیدا کنند.
          </p>
        </div>
