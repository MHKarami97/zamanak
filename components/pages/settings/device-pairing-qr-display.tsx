  ...
  return (
    <div className="mt-3 rounded-2xl border border-[var(--border)] bg-white p-3 text-slate-950" data-device-pairing-qr>
      <div className="mb-2 flex items-center justify-between gap-3 text-[10px] font-bold">
        <span className="flex items-center gap-1.5"><QrCode className="size-4" /> اسکن سریع با زمانک</span>
      ...
      <svg
        ...
        role="img"
        aria-label={multiFrame ? `QR اتصال، فریم ${frameIndex + 1} از ${frames.length}` : "QR اتصال زمانک"}
