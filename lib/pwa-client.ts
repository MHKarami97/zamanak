...
export const PWA_EVENT = {
  installAvailable: "zamaanak:pwa-install-available",
  installed: "zamaanak:pwa-installed",
  updateAvailable: "zamaanak:pwa-update-available",
} as const;

declare global {
  interface Window {
    __zamaanakInstallPrompt?: BeforeInstallPromptEvent;
  }
...
export function getDeferredInstallPrompt() {
  return typeof window === "undefined" ? undefined : window.__zamaanakInstallPrompt;
}

export function setDeferredInstallPrompt(event?: BeforeInstallPromptEvent) {
  if (typeof window === "undefined") return;
  window.__zamaanakInstallPrompt = event;
}
